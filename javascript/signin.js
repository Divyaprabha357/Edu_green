...
function signIn() {
    ...
    .then(() => {
        const college = document.getElementById("collegeName").value || "Nearest College";

        const whatsappMessage = `
        Hello,

        An issue has been raised through the Sahay platform.

        Name: ${name}
        Phone: ${phone}
        Email: ${email}
        Location: ${location}
        Nearest College: ${college}
        ...
        Thank you.
            ...
            alert("Your issue has been submitted. You will now be redirected to WhatsApp.");
